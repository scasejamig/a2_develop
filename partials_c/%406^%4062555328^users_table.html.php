        ...
        <td class="right_column">
            <i class="icon icon_ellipsis" onclick="common.menu_popup_toggle(this, event);">
                <div class="menu_popup">
                    <div onclick="common.user_edit_window(<?php echo self::$_tpl_vars['users'][self::$_sections['i']['index']]['plot_id']; ?>
, event);">Edit</div>
					<div onclick="common.user_delete_window(<?php echo self::$_tpl_vars['users'][self::$_sections['i']['index']]['plot_id']; ?>
, event);">Delete</div>
                </div>
            </i>
        </td>
